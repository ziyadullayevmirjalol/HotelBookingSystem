...
namespace HotelBookingSystem.Presentation.SpectreUI.AdminPanel.Actions;
...
public class AdminActions
{
    ...
    again:
        ...
        {
            case 1:
                model.ApartmentType = Domain.Enums.ApartmentType.Econo;
                break;
            case 2:
                model.ApartmentType = Domain.Enums.ApartmentType.Normal;
                break;
            case 3:
                model.ApartmentType = Domain.Enums.ApartmentType.Premium;
                break;
            default:
